...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=25000, fname='new.h5', replace_target=25):
    ...
    def load_model_from_h5(self):
        # Load the model with the MeanSquaredError loss explicitly
        self.brain_eval.model = load_model(self.model_file, custom_objects={'mse': MeanSquaredError()})
        self.brain_target.model = load_model(self.model_file, custom_objects={'mse': MeanSquaredError()})
